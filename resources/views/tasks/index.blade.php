...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 10px;">
    ...
    @if(auth()->check() && auth()->user() && auth()->user()->hasPermission('tasks.create', session('hotel_id')) || auth()->check() && auth()->user()->isSuperAdmin())
            ...
            @forelse($tasks as $task)
                <tr>
                    ...
                    <td>
                        ...
                        @if(auth()->check() && auth()->user() && auth()->user()->hasPermission('tasks.edit', session('hotel_id')) || auth()->check() && auth()->user()->isSuperAdmin())
