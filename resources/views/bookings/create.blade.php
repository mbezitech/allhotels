...
<div style="background: white; border-radius: 12px; padding: 30px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    <form method="POST" action="{{ route('bookings.store') }}">
        ...
        <div class="grid-2">
            ...
            <div class="form-group">
                ...
                <div style="display: flex; gap: 10px;">
                    ...
                    <input type="tel" id="guest_phone" name="guest_phone" value="{{ old('guest_phone') }}" placeholder="Phone number" style="flex: 1; padding: 12px; border: 2px solid #e0e0e0; border-radius: 8px; font-size: 14px;" oninput="validatePhoneNumber()">
                </div>
        ...
        <div class="form-group">
            ...
            <input type="number" id="discount" name="discount" value="{{ old('discount', 0) }}" step="0.01" min="0" oninput="calculateFinalAmount()">
...
function initializeCountryDropdown() {
    ...
    if (typeof getAllCountries === 'function') {
        ...
        allCountries.forEach(country => {
            ...
            // Check if this is the old selected value
            const oldValue = searchInput.getAttribute('data-old-value') || '+1';
            if (country.code === oldValue) {
